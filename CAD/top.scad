...
module screens()
{
    ...
    screw_anchor_coords =
        [ anchor_coords.x + screen_pcb_screw_holes_center_from_board_edge_distance.x, anchor_coords.y - screw_dist, 0 ];
    translate(anchor_coords)
        cuboid([ screen_pcb_size.x * screen_count, active_screen_area.y, panel_thickness ],
    ...
    {
        translate(screw_anchor_coords) translate([ screen_pcb_size.x * i, 0, 0 ]) screen_screw_set();
    }
}
