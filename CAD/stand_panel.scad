...
screen_pcb_screw_holes_center_from_board_edge_distance = [ 2.1, 2.0 ]; // mm
screen_pcb_screw_holes_diameter = 2.8;                                 // mm
screen_pcb_screw_holes_spacing = [ 20.5, 23 ];                         // mm
active_screen_area = [ 21.74, 10.86 ];                                 // mm (old: 13.86)
active_screen_area_offset_from_corner = [ 1.48, 6.58 ];                // mm
...
m2_screw_diameter = 2;        // mm

// Asanoha
asanoha_pattern_size = [ 40.7, 20.35 ]; // mm
...
stand_asanoha_pattern_size = [stand_asanoha_pattern_unit_length*stand_asanoha_repeat.x,stand_asanoha_pattern_unit_length*stand_asanoha_repeat.y];
module asanoha_area(asanoha_anchor = [])
{
    translate(asanoha_anchor) cuboid([ stand_asanoha_pattern_size.x, stand_asanoha_pattern_size.y, stand_panel_thickness ],
...
{
    asanoha_anchor =
        [ stand_panel_size.x / 2 - stand_asanoha_pattern_size.x / 2, stand_panel_size.y / 2 - stand_asanoha_pattern_size.y / 2, 0 ];
    difference()
    {
...
stand_panel_size = [ panel_size.x - stand_size.x * 2 - stand_panel_tolerance * 2, panel_size.y-stand_size.y/2+stand_hinge_ball_diameter/2 ];
